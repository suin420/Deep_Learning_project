...
# +
folder_path = 'final_data/valid/labels'
...
input_folder = 'final_data/valid/labels/' # 입력 이미지 폴더 경로
output_folder = 'final_data/valid/labels_pre/' # 출력 이미지 폴더 경로
...
# +
source_folder = 'final_data/valid/labels_pre'
...
# +
source_folder = 'final_data/valid/labels'
